...
{
	InvokerActionInvoker5< String_t*, String_t*, String_t*, String_t*, String_t* >::Invoke(__this->___method_ptr_0, method, NULL, ___0_subject, ___1_payload, ___2_receipt, ___3_transactionId, ___4_originalTransactionId);
}
void UnityPurchasingCallback_Invoke_m0F05D96994D5D9CF3F9DAE457764FA18E55CFCE0_ClosedStaticInvoker(UnityPurchasingCallback_tFC58410D7A50DD05CC7430C76C7E0277A213757D* __this, String_t* ___0_subject, String_t* ___1_payload, String_t* ___2_receipt, String_t* ___3_transactionId, String_t* ___4_originalTransactionId, const RuntimeMethod* method)
{
	InvokerActionInvoker6< RuntimeObject*, String_t*, String_t*, String_t*, String_t*, String_t* >::Invoke(__this->___method_ptr_0, method, NULL, __this->___m_target_2, ___0_subject, ___1_payload, ___2_receipt, ___3_transactionId, ___4_originalTransactionId);
}
...
IL_006b:
	{
		// json.Read();
		StringReader_t1A336148FF22A9584E759A9D720CC96C23E35DD8* L_14 = __this->___json_0;
		NullCheck(L_14);
		int32_t L_15;
...
IL_00e6:
	{
		// json.Read();
		StringReader_t1A336148FF22A9584E759A9D720CC96C23E35DD8* L_15 = __this->___json_0;
		NullCheck(L_15);
		int32_t L_16;
