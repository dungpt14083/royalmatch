...
public class LevelMakerEditor : EditorWindow
{
    ...
    float myFloat = 1.23f;
    int levelNumber = 1;
    int miniGameLevelNumber = 0;
    int miniGameLevelTarget = 0;
    int maxRows;
    int maxCols;
    public static SquareBlocks[] levelSquares = new SquareBlocks[81];
    SquareBlocks squareBlock;
    ...
    private int obstacleSelected = -1;
    private int currentRow = -1;
    private int currentCol = -1;

    Dictionary<ItemsTypes, GUIContent> itemTextures;
    Dictionary<ObstacleTypes, GUIContent> obstacleTextures;
    Dictionary<ObstacleTypes, ObstacleBase> obstaclePrefabs;
    ...
    void OnFocus()
    {
        ...
        if (EditorSceneManager.GetActiveScene().name == "game")
        {
            ...
            InitItemTextures(lm);
            InitObstacleTextures(lm);


        }
    }
    void InitItemTextures(LevelManager lm)
    {
        //add itemTextures
        if (itemTextures != null) return;
        itemTextures = new Dictionary<ItemsTypes, GUIContent>();
        itemTextures.Add(ItemsTypes.BLUE, new GUIContent("itemBlue", lm.itemBluePrefab.sprRenderer.sprite.texture));
        itemTextures.Add(ItemsTypes.GREEN, new GUIContent("itemGreen", lm.itemGreenPrefab.sprRenderer.sprite.texture));
        itemTextures.Add(ItemsTypes.RED, new GUIContent("itemRed", lm.itemRedPrefab.sprRenderer.sprite.texture));
        itemTextures.Add(ItemsTypes.PINK, new GUIContent("itemPink", lm.itemPinkPrefab.sprRenderer.sprite.texture));
        itemTextures.Add(ItemsTypes.YELLOW, new GUIContent("itemYellow", lm.itemYellowPrefab.sprRenderer.sprite.texture));
        itemTextures.Add(ItemsTypes.HORIZONTAL_STRIPPED, new GUIContent("itemHorizontal", lm.itemHorizontalPrefab.sprRenderer.sprite.texture));
        itemTextures.Add(ItemsTypes.VERTICAL_STRIPPED, new GUIContent("itemVertical", lm.itemVerticalPrefab.sprRenderer.sprite.texture));
        itemTextures.Add(ItemsTypes.PACKAGE, new GUIContent("itemPackage", lm.itemPackagePrefab.sprRenderer.sprite.texture));
        itemTextures.Add(ItemsTypes.BOMB, new GUIContent("itemBomb", lm.itemBombPrefab.sprRenderer.sprite.texture));
        itemTextures.Add(ItemsTypes.PROPELLER, new GUIContent("itemPropeller", lm.itemPropellerPrefab.sprRenderer.sprite.texture));
        itemTextures.Add(ItemsTypes.Egg, new GUIContent("itemEgg", lm.itemEggPrefab.sprRenderer.sprite.texture));
        itemTextures.Add(ItemsTypes.Diamon, new GUIContent("itemDiamon", lm.itemDiamonPrefab.sprRenderer.sprite.texture));
        itemTextures.Add(ItemsTypes.Piggy, new GUIContent("itemPiggy", lm.itemPiggyPrefab.sprRenderer.sprite.texture));
        itemTextures.Add(ItemsTypes.PiggyHelmet, new GUIContent("itemPiggyHelmet", lm.itemPiggyHelmetPrefab.sprRenderer.sprite.texture));
        itemTextures.Add(ItemsTypes.Pumpkin, new GUIContent("itemPumpkin", lm.itemPumpkinPrefab.sprRenderer.sprite.texture));
        itemTextures.Add(ItemsTypes.Vase, new GUIContent("itemVase", lm.itemVasePrefab.sprRenderer.sprite.texture));
    }
    void InitObstacleTextures(LevelManager lm)
    {
        if (obstacleTextures != null) return;
        //add obstacleTextures
        obstacleTextures = new Dictionary<ObstacleTypes, GUIContent>();

        obstacleTextures.Add(ObstacleTypes.Box, new GUIContent("box", lm.boxObstaclePrefab.GetTargetIcon().texture));
        obstacleTextures.Add(ObstacleTypes.BlueBox, new GUIContent("blueBox", lm.blueBoxObstaclePrefab.GetTargetIcon().texture));
        obstacleTextures.Add(ObstacleTypes.GreenBox, new GUIContent("greenBox", lm.greenBoxObstaclePrefab.GetTargetIcon().texture));
        obstacleTextures.Add(ObstacleTypes.PinkBox, new GUIContent("pinkBox", lm.pinkBoxObstaclePrefab.GetTargetIcon().texture));
        obstacleTextures.Add(ObstacleTypes.RedBox, new GUIContent("redBox", lm.redBoxObstaclePrefab.GetTargetIcon().texture));
        obstacleTextures.Add(ObstacleTypes.YellowBox, new GUIContent("yellowBox", lm.yellowBoxObstaclePrefab.GetTargetIcon().texture));
        obstacleTextures.Add(ObstacleTypes.Cupboard, new GUIContent("cupboard", lm.cupboardObstaclePrefab.GetTargetIcon().texture));
        obstacleTextures.Add(ObstacleTypes.DogBox, new GUIContent("dogBox", lm.dogBoxPrefab.GetTargetIcon().texture));
        obstacleTextures.Add(ObstacleTypes.Garden, new GUIContent("garden", lm.gardenPrefab.GetTargetIcon().texture));
        obstacleTextures.Add(ObstacleTypes.Grass, new GUIContent("grass", lm.grassPrefab.GetTargetIcon().texture));
        obstacleTextures.Add(ObstacleTypes.Hat, new GUIContent("hat", lm.hatPrefab.GetTargetIcon().texture));
        obstacleTextures.Add(ObstacleTypes.Lantern, new GUIContent("lantern", lm.lanternObstaclePrefab.GetTargetIcon().texture));
        obstacleTextures.Add(ObstacleTypes.MailBox, new GUIContent("mailBox", lm.mailBoxPrefab.GetTargetIcon().texture));
        obstacleTextures.Add(ObstacleTypes.Mole, new GUIContent("mole", lm.moleObstaclePrefab.GetTargetIcon().texture));
        obstacleTextures.Add(ObstacleTypes.Pot, new GUIContent("pot", lm.potPrefab.GetTargetIcon().texture));
        obstacleTextures.Add(ObstacleTypes.RockGem, new GUIContent("rockGem", lm.rockGemObstaclePrefab.GetTargetIcon().texture));
        obstacleTextures.Add(ObstacleTypes.RockOwl, new GUIContent("rockOwl", lm.rockOwlObstaclePrefab.GetTargetIcon().texture));
        obstacleTextures.Add(ObstacleTypes.Safe, new GUIContent("safe", lm.safeObstaclePrefab.GetTargetIcon().texture));
        obstacleTextures.Add(ObstacleTypes.Soil, new GUIContent("soil", lm.soilPrefab.GetTargetIcon().texture));

        obstaclePrefabs = new Dictionary<ObstacleTypes, ObstacleBase>();
        obstaclePrefabs.Add(ObstacleTypes.Box, lm.boxObstaclePrefab);
        obstaclePrefabs.Add(ObstacleTypes.BlueBox, lm.blueBoxObstaclePrefab);
        obstaclePrefabs.Add(ObstacleTypes.GreenBox, lm.greenBoxObstaclePrefab);
        obstaclePrefabs.Add(ObstacleTypes.PinkBox, lm.pinkBoxObstaclePrefab);
        obstaclePrefabs.Add(ObstacleTypes.RedBox, lm.redBoxObstaclePrefab);
        obstaclePrefabs.Add(ObstacleTypes.YellowBox, lm.yellowBoxObstaclePrefab);
        obstaclePrefabs.Add(ObstacleTypes.Cupboard, lm.cupboardObstaclePrefab);
        obstaclePrefabs.Add(ObstacleTypes.DogBox, lm.dogBoxPrefab);
        obstaclePrefabs.Add(ObstacleTypes.Garden, lm.gardenPrefab);
        obstaclePrefabs.Add(ObstacleTypes.Grass, lm.grassPrefab);
        obstaclePrefabs.Add(ObstacleTypes.Hat, lm.hatPrefab);
        obstaclePrefabs.Add(ObstacleTypes.Lantern, lm.lanternObstaclePrefab);
        obstaclePrefabs.Add(ObstacleTypes.MailBox, lm.mailBoxPrefab);
        obstaclePrefabs.Add(ObstacleTypes.Mole, lm.moleObstaclePrefab);
        obstaclePrefabs.Add(ObstacleTypes.Pot, lm.potPrefab);
        obstaclePrefabs.Add(ObstacleTypes.RockGem, lm.rockGemObstaclePrefab);
        obstaclePrefabs.Add(ObstacleTypes.RockOwl, lm.rockOwlObstaclePrefab);
        obstaclePrefabs.Add(ObstacleTypes.Safe, lm.safeObstaclePrefab);
        obstaclePrefabs.Add(ObstacleTypes.Soil, lm.soilPrefab);
    }
    void Initialize()
    {
        ...
        for (int i = 0; i < levelSquares.Length; i++)
        {
            ...
            sqBlocks.itemsType = ItemsTypes.NONE;
    ...
    void OnGUI()
    {
        ...
        scrollViewVector = GUI.BeginScrollView(new Rect(25, 45, position.width - 30, position.height), scrollViewVector, new Rect(0, 0, 400, 2500));
        GUILayout.Space(-30);
    ...
    void TestLevel(bool playNow = true, bool testByPlay = true)
    {
        ...
        lm.LoadLevel(out List<ObstacleMapConfig> obstacles);
    }
    ...
    void GUIBlocks()
    {
        ...
        if (GUILayout.Button("Clear", new GUILayoutOption[] { GUILayout.Width(50), GUILayout.Height(50) }))
        {
            for (int i = 0; i < levelSquares.Length; i++)
            {
                levelSquares[i].squareType = SquareTypes.EMPTY;
                levelSquares[i].obstacleType = ObstacleTypes.None;
                levelSquares[i].itemsType = ItemsTypes.NONE;
                levelSquares[i].GenItems = new List<ItemsTypes>();
            }
            SaveLevel();
        }
        GUILayout.EndHorizontal();
    ...
    public List<ItemsTypes> DefaultGenItemTypes()
    {
        List<ItemsTypes> result = new List<ItemsTypes> {
            ItemsTypes.BLUE,
            ItemsTypes.GREEN,
            ItemsTypes.RED,
            ItemsTypes.YELLOW,
    ...
    void GUIGameField()
    {
        ...
        if (GUILayout.Button(squareTex, new GUILayoutOption[] { GUILayout.Width(50), GUILayout.Height(50) }))
        {
            itemSelected = -1;
            obstacleSelected = -1;
            squareBlock = new SquareBlocks { squareType = SquareTypes.EMPTY };
        }
        ...
        if (GUILayout.Button("X", new GUILayoutOption[] { GUILayout.Width(50), GUILayout.Height(50) }))
        {
            itemSelected = -1;
            obstacleSelected = -1;
            squareBlock = new SquareBlocks { squareType = SquareTypes.NONE };
        }
        GUILayout.Label(" - none", EditorStyles.boldLabel);
        GUILayout.EndHorizontal();

        GUILayout.BeginHorizontal();
        GUI.color = new Color(1f, 0.5f, 0.8f);
        if (GUILayout.Button("G", new GUILayoutOption[] { GUILayout.Width(50), GUILayout.Height(50) }))
        {
            itemSelected = -1;
            obstacleSelected = -1;
            squareBlock = new SquareBlocks { squareType = SquareTypes.EMPTY, GenItems = DefaultGenItemTypes() };
        }
        GUI.color = new Color(1f, 1f, 1f);
        GUILayout.Label("GenItem", EditorStyles.boldLabel);

        GUILayout.EndHorizontal();
        GUILayout.BeginHorizontal();
        if (GUILayout.Button("UnSelectd", new GUILayoutOption[] { GUILayout.Width(150), GUILayout.Height(50) }))
        {
            itemSelected = -1;
            obstacleSelected = -1;
            squareBlock = null;
        ...
        GUILayout.Space(10);
        itemSelected = GUILayout.SelectionGrid(itemSelected, itemTextures.Values.ToArray(), 8, new GUILayoutOption[] { GUILayout.Width(1200), GUILayout.Height(150) });
        GUILayout.EndVertical();
        GUILayout.EndHorizontal();
        GUILayout.Space(10);
        ...
        for (int row = 0; row < maxRows; row++)
        {
            ...
            for (int col = 0; col < maxCols; col++)
            {
                ...
                if (levelSquares[row * maxCols + col].squareType == SquareTypes.NONE)
                {
                    imageButton = "X";
                    squareColor = new Color(0.8f, 0.8f, 0.8f);


                    //if (levelSquares[row * maxCols + col].GenItems.Count > 0)
                    //{
                    //    squareColor = new Color(1f, 0.5f, 0.8f);
                    //    imageButton = "Gen";
                    //}
                    GUI.color = squareColor;
                    if (GUILayout.Button(imageButton as string, new GUILayoutOption[] {
                        GUILayout.Width (50),
                        GUILayout.Height (50)
                    }))
                    {
                        ...
                        currentRow = row;
                        currentCol = col;
                        if (itemSelected > -1 || squareBlock != null)
                        {
                            SetType(col, row);
                        }
                ...
                else if (levelSquares[row * maxCols + col].squareType == SquareTypes.EMPTY)
                {
                    var key = levelSquares[row * maxCols + col].itemsType;
                    if (itemTextures.ContainsKey(key))
                    {
                        imageButton = itemTextures[levelSquares[row * maxCols + col].itemsType].image;
        ...
        if (currentRow > -1 && currentCol > -1)
        {
            ...
            var currentSquare = levelSquares[currentRow * maxCols + currentCol];
            GUILayout.BeginVertical();

            GUILayout.Label("GenItemsAll : ", new GUILayoutOption[] { GUILayout.Width(100) });
            GUILayout.BeginHorizontal();
            foreach (var Item in itemTextures)
            {
                if (GUILayout.Button(Item.Value.image, new GUILayoutOption[] {
                        GUILayout.Width (50),
                        GUILayout.Height (50)
                    }))
                {
                    if (!currentSquare.GenItems.Contains(Item.Key))
                    {
                        currentSquare.GenItems.Add(Item.Key);
                        SaveLevel();
                    }
                }
            }
            GUILayout.EndHorizontal();
            GUILayout.Label("GenItemsSelected : ", new GUILayoutOption[] { GUILayout.Width(150) });
            if (currentSquare.GenItems.Count > 0)
            {
                GUILayout.BeginHorizontal();
                List<ItemsTypes> removeItemTypes = new List<ItemsTypes>();
                foreach (var genItem in currentSquare.GenItems)
                {
                    if(GUILayout.Button(itemTextures[genItem].image, new GUILayoutOption[] {
                        GUILayout.Width (50),
                        GUILayout.Height (50)
                    }))
                    {
                        removeItemTypes.Add(genItem);
                    }
                }
                if(removeItemTypes.Count > 0)
                {
                    foreach (var genItem in removeItemTypes)
                    {
                        levelSquares[currentRow * maxCols + currentCol].GenItems.Remove(genItem);
                    }
                    SaveLevel();
                }
                GUILayout.EndHorizontal();
    ...
    void GUIGameObstacles()
    {
        GUILayout.Space(10);
        GUILayout.Label("Obstacles:", EditorStyles.boldLabel);
        GUILayout.Space(10);
        obstacleSelected = GUILayout.SelectionGrid(obstacleSelected, obstacleTextures.Values.ToArray(), 8, new GUILayoutOption[] { GUILayout.Width(1000), GUILayout.Height(150) });
        GUILayout.Space(10);
        GUILayout.Label("Obstacles Config:", EditorStyles.boldLabel);
        GUILayout.Space(10);
        GUILayout.BeginVertical();
        List<SquareBlocks> squareBlocksObs = new List<SquareBlocks>();
        List<Vector2> squareBlocksObsPoint = new List<Vector2>();
        for (int row = 0; row < maxRows; row++)
        {
            GUILayout.BeginHorizontal();
            ...
            for (int col = 0; col < maxCols; col++)
            {
                ...
                if (levelSquares[row * maxCols + col].squareType == SquareTypes.NONE)
                {
                    ...
                    {
                        itemSelected = -1;
                        if (obstacleSelected > -1 || squareBlock != null)
                        {
                            SetType(col, row);
                        }
                    }
                ...
                {
                    var key = levelSquares[row * maxCols + col].obstacleType;
                    if (obstacleTextures.ContainsKey(key))
                    {
                        imageButton = squareTex;
                        squareColor = Color.white;
                        squareBlocksObsPoint.Add(new Vector2(row, col));
                        squareBlocksObs.Add(levelSquares[row * maxCols + col]);
                    }
                    else
                    {
                        imageButton = squareTex;
        ...
        for (int i = 0; i < squareBlocksObs.Count; i++)
        {
            var obs = squareBlocksObs[i];
            var size = obstaclePrefabs[obs.obstacleType].size;
            var pos = squareBlocksObsPoint[i];
            GUIStyle StatesLabel = new GUIStyle(GUI.skin.box)
            {
                alignment = TextAnchor.MiddleCenter,
            };
            GUILayout.BeginArea(new Rect(pos.y * 3.5f + pos.y * 50f, 570 + pos.x * 3.5f + pos.x * 50f, size.x * 50, size.y * 50), obstacleTextures[obs.obstacleType].image, StatesLabel);
            GUILayout.EndArea();
        }
        GUILayout.EndVertical();
        GUI.color = new Color(1, 1, 1, 1f);
    ...
    public void AddMiniGame()
    {
        ...
        GUILayout.BeginHorizontal();
        GUILayout.Label("MiniGameLevelNumber", new GUILayoutOption[] {
                    GUILayout.Width (150),
                });
        string changeLvl = GUILayout.TextField(miniGameLevelNumber.ToString(), new GUILayoutOption[] { GUILayout.Width(50) });
        try
        {
            changeLvl.Trim();
            int levelNew = int.Parse(changeLvl);
            if (levelNew != miniGameLevelNumber)
            {
                miniGameLevelNumber = levelNew;
                SaveLevel();
            }
        ...
        GUILayout.EndHorizontal();
        LevelHeroRescues levelHeroRescues = Resources.Load<LevelHeroRescues>("levels/Level " + miniGameLevelNumber.ToString());
        if (levelHeroRescues == null)
        {
            GUILayout.Label("MiniGameLevel Not Exist", new GUILayoutOption[] {
                    GUILayout.Width (150),
                });
        }
        else
        {
            ...
            if(levelHeroRescues.pinLongs.Count > 0)
            {
                GUILayout.BeginHorizontal();
                GUILayout.Label("MiniGameLevelTarget", new GUILayoutOption[] {
                    GUILayout.Width (150),
                });
                string changeLvlTarget = GUILayout.TextField(miniGameLevelTarget.ToString(), new GUILayoutOption[] { GUILayout.Width(50) });
                try
                {
                    changeLvlTarget.Trim();
                    int LvlTargetNew = int.Parse(changeLvlTarget);
                    if (LvlTargetNew != miniGameLevelTarget)
                    {
                        miniGameLevelTarget = LvlTargetNew;
                        SaveLevel();
                    }
                ...
                GUILayout.Space(20);
                if (GUILayout.Button("Open  MiniGameLevelTarget", new GUILayoutOption[] {
                        GUILayout.Width (200),
                }))
                {
                    OpenMiniGameLevelTarget();
                }
                GUILayout.EndHorizontal();
            }
            else
            {
                GUILayout.Label("MiniGameLevel Not Exist List Key", new GUILayoutOption[] {
                        GUILayout.Width (200),
                    });
            }
    ...
    private void OpenMiniGameLevelTarget()
    {
        var asset = Resources.Load<TargetLevel>("Targets/miniGameLevelTarget" + miniGameLevelTarget);
        if (asset == null)
        {
            asset = CreateInstance<TargetLevel>();
            asset.name = "miniGameLevelTarget" + miniGameLevelTarget;
            string assetPathAndName = AssetDatabase.GenerateUniqueAssetPath("Assets/HeroRescues/Resources/Targets/miniGameLevelTarget" + miniGameLevelTarget + ".asset");
            AssetDatabase.CreateAsset(asset, assetPathAndName);
            AssetDatabase.SaveAssets();
            AssetDatabase.Refresh();
        }
    ...
    {
        SquareBlocks squareBlocksCurrent = levelSquares[row * maxCols + col];
        if (squareBlock != null)
        {
            if (squareBlock.GenItems.Count > 0)
            {
                squareBlocksCurrent.GenItems = squareBlock.GenItems;
                squareBlocksCurrent.squareType = SquareTypes.EMPTY;
            }
            else
            {
                squareBlocksCurrent = squareBlock;
            }
        }
        if (itemSelected >= 0 && itemSelected < itemTextures.Count)
        {
            squareBlock = null;
            //squareBlocksCurrent = levelSquares[row * maxCols + col];
            var item = itemTextures.Values.ToList()[itemSelected];
            switch (item.text)
            {
                case "itemBlue":
                    squareBlocksCurrent.itemsType = ItemsTypes.BLUE;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "itemGreen":
                    squareBlocksCurrent.itemsType = ItemsTypes.GREEN;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "itemRed":
                    squareBlocksCurrent.itemsType = ItemsTypes.RED;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "itemPink":
                    squareBlocksCurrent.itemsType = ItemsTypes.PINK;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "itemYellow":
                    squareBlocksCurrent.itemsType = ItemsTypes.YELLOW;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "itemHorizontal":
                    squareBlocksCurrent.itemsType = ItemsTypes.HORIZONTAL_STRIPPED;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "itemVertical":
                    squareBlocksCurrent.itemsType = ItemsTypes.VERTICAL_STRIPPED;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "itemPackage":
                    squareBlocksCurrent.itemsType = ItemsTypes.PACKAGE;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "itemBomb":
                    squareBlocksCurrent.itemsType = ItemsTypes.BOMB;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "itemPropeller":
                    squareBlocksCurrent.itemsType = ItemsTypes.PROPELLER;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "itemEgg":
                    squareBlocksCurrent.itemsType = ItemsTypes.Egg;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "itemDiamon":
                    squareBlocksCurrent.itemsType = ItemsTypes.Diamon;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "itemPiggy":
                    squareBlocksCurrent.itemsType = ItemsTypes.Piggy;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "itemPiggyHelmet":
                    squareBlocksCurrent.itemsType = ItemsTypes.PiggyHelmet;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "itemPumpkin":
                    squareBlocksCurrent.itemsType = ItemsTypes.Pumpkin;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "itemVase":
                    squareBlocksCurrent.itemsType = ItemsTypes.Vase;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
            }
        }
        if (obstacleSelected >= 0 && obstacleSelected < obstacleTextures.Count)
        {
            squareBlock = null;
            //squareBlocksCurrent = new SquareBlocks();
            var item = obstacleTextures.Values.ToList()[obstacleSelected];
            switch (item.text)
            {
                case "box":
                    squareBlocksCurrent.obstacleType = ObstacleTypes.Box;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "blueBox":
                    squareBlocksCurrent.obstacleType = ObstacleTypes.BlueBox;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "greenBox":
                    squareBlocksCurrent.obstacleType = ObstacleTypes.GreenBox;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "pinkBox":
                    squareBlocksCurrent.obstacleType = ObstacleTypes.PinkBox;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "redBox":
                    squareBlocksCurrent.obstacleType = ObstacleTypes.RedBox;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "yellowBox":
                    squareBlocksCurrent.obstacleType = ObstacleTypes.YellowBox;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "cupboard":
                    squareBlocksCurrent.obstacleType = ObstacleTypes.Cupboard;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "dogBox":
                    squareBlocksCurrent.obstacleType = ObstacleTypes.DogBox;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "garden":
                    squareBlocksCurrent.obstacleType = ObstacleTypes.Garden;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "grass":
                    squareBlocksCurrent.obstacleType = ObstacleTypes.Grass;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "hat":
                    squareBlocksCurrent.obstacleType = ObstacleTypes.Hat;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "lantern":
                    squareBlocksCurrent.obstacleType = ObstacleTypes.Lantern;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "mailBox":
                    squareBlocksCurrent.obstacleType = ObstacleTypes.MailBox;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "mole":
                    squareBlocksCurrent.obstacleType = ObstacleTypes.Mole;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "pot":
                    squareBlocksCurrent.obstacleType = ObstacleTypes.Pot;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "rockGem":
                    squareBlocksCurrent.obstacleType = ObstacleTypes.RockGem;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "rockOwl":
                    squareBlocksCurrent.obstacleType = ObstacleTypes.RockOwl;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "safe":
                    squareBlocksCurrent.obstacleType = ObstacleTypes.Safe;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
                case "soil":
                    squareBlocksCurrent.obstacleType = ObstacleTypes.Soil;
                    squareBlocksCurrent.squareType = SquareTypes.EMPTY;
                    break;
            }
        }
        levelSquares[row * maxCols + col] = squareBlocksCurrent;
        //Debug.Log($"levelSquares row = {row} col = {col} squareBlock.itemsType = {squareBlock.itemsType} temp.obstacleType = {squareBlock.obstacleType}");
        squareBlocksCurrent = null;
        Debug.Log($"levelSquares squareBlock = null {squareBlock == null}");
        SaveLevel();
    }
    public void SaveMap(string fileName)
    {
        ...
        //saveString += "\r\n";
        saveString += "MiniGameLevel " + miniGameLevelNumber;
        saveString += "\r\n";
        if(miniGameLevelNumber > 0 && miniGameLevelTarget > 0)
        {
            saveString += "MiniGameLevelTarget " + miniGameLevelTarget;
            saveString += "\r\n";
        }
        ...
        for (int row = 0; row < maxRows; row++)
        {
            ...
            {
                string genItem = "";
                foreach (var gen in levelSquares[row * maxCols + col].GenItems)
                {
                    genItem += "-" + (int)gen;
                }
                saveString += (int)levelSquares[row * maxCols + col].squareType + "_" + (int)levelSquares[row * maxCols + col].itemsType + "_" + (int)levelSquares[row * maxCols + col].obstacleType + "_" + genItem;
    ...
    void ProcessGameDataFromString(string mapText)
    {
        ...
        foreach (string line in lines)
        {
            if (line.StartsWith("MODE "))
            {
                ...
                target = (TargetTypes)int.Parse(modeString);
            }
            ...
            { //Maps
              //Split lines again to get map numbers
                ...
                for (int i = 0; i < st.Length; i++)
                {
                    ...
                    try
                    {
                        if (stCell.Length >= 1) levelSquares[mapLine * maxCols + i].squareType = (SquareTypes)int.Parse(stCell[0].ToString());
                        if (stCell.Length >= 2) levelSquares[mapLine * maxCols + i].itemsType = (ItemsTypes)int.Parse(stCell[1].ToString());
                        if (stCell.Length >= 3) levelSquares[mapLine * maxCols + i].obstacleType = (ObstacleTypes)int.Parse(stCell[2].ToString());
                        if (stCell.Length >= 4)
                        {
                            levelSquares[mapLine * maxCols + i].GenItems = new List<ItemsTypes>();
                            ...
                            for (int g = 0; g < stGen.Length; g++)
                            {
                                ...
                                levelSquares[mapLine * maxCols + i].GenItems.Add((ItemsTypes)result);
                            }
                        }
                    }
                    catch (Exception e)
