...
public class InitScript : MonoBehaviour
{
    ...
    {
#if UNITY_ADS
        Debug.Log("show Unity Rewarded ads video in " + LevelManager.Instance.gameStatus);
        ...
        if(stillShow)
        {
            Debug.Log("show Admob Rewarded ads video in " + LevelManager.Instance.gameStatus);
    ...
    {    //1.4 added
        foreach (AdEvents item in adsEvents)
        {
            ...
            {
                //1.5   1.6.1
                //				if ((LevelManager.Instance.gameStatus == GameState.GameOver || LevelManager.Instance.gameStatus == GameState.Pause ||
                //				    LevelManager.Instance.gameStatus == GameState.Playing || LevelManager.Instance.gameStatus == GameState.PrepareGame || LevelManager.Instance.gameStatus == GameState.PreWinAnimations ||
                //				    LevelManager.Instance.gameStatus == GameState.RegenLevel || LevelManager.Instance.gameStatus == GameState.Win)) {
    ...
    {  //1.4 added
#if UNITY_ADS
        Debug.Log("show Unity ads video in " + LevelManager.Instance.gameStatus);
    ...
    public void ShowAds(bool chartboost = true)
    {
        ...
        {
#if CHARTBOOST_ADS
            Debug.Log("show Chartboost Interstitial in " + LevelManager.Instance.gameStatus);
        ...
        {
#if GOOGLE_MOBILE_ADS
            Debug.Log("show Google mobile ads Interstitial in " + LevelManager.Instance.gameStatus);
...
//    }
    ...
    public void OnLevelClicked(object sender, LevelReachedEventArgs args)
    {
        ...
        if (!GameObject.Find("CanvasGlobal").transform.Find("MenuPlay").gameObject.activeSelf && !GameObject.Find("CanvasGlobal").transform.Find("GemsShop").gameObject.activeSelf && !GameObject.Find("CanvasGlobal").transform.Find("LiveShop").gameObject.activeSelf && !GameObject.Find("CanvasGlobal").transform.Find("Settings").gameObject.activeSelf)  //2.1.6
        {
            ...
            LevelManager.Instance.LoadLevel(out List<ObstacleMapConfig> obstacles);
